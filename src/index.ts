      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            applyAutoLimit: { type: "boolean", description: "Whether to apply auto limit to the query. Defaults to true. Set to false for MSSQL data sources to avoid invalid LIMIT syntax.", default: true }
          },
